...
namespace DynamicCRUD.T4Templates
{
    public partial class GenericIDataService
    {
        ...
        public GenericIDataService(IEnumerable<ClientDatabaseColumn> databaseColumns, string modelName, string modelNameCamelCase, string pluralTablename, string primaryKeyName, string primaryKeyDataType, string Namespace = "ARM.Data.AutoGenClasses")
        {
