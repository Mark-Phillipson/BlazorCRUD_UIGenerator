...
namespace DynamicCRUD.T4Templates
{
    public partial class GenericIDataService
    {
        ...
        string DTONamespaceName { get; set; } = "";

        public GenericIDataService(IEnumerable<ClientDatabaseColumn> databaseColumns, string modelName, string modelNameCamelCase, string pluralTablename, string primaryKeyName, string primaryKeyDataType, string Namespace, string foreignKeyName, string foreignKeyDataType, string dtoNamespaceName)
        {
