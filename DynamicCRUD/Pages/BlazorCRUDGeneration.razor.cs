...
namespace DynamicCRUD.Pages;
    ...
    public partial class BlazorCRUDGeneration
    {
        ...
        private ElementReference? tableFilter;
        ...
        private void GenerateClasses()
        {
            ...
            var namespaceString = "BostonAcademic.Client.AutoGenClasses";
            ...
            GenericIRepository genericIRepository = new(Columns, ModelName, camelTablename, PluralName, primaryKeyName, primaryKeyDatatype, namespaceString);
            ...
            GenericRepository genericRepository = new(Columns, ModelName, camelTablename, PluralName, primaryKeyName, primaryKeyDatatype, namespaceString);
            ...
            GenericIDataService genericIDataService = new(Columns, ModelName, camelTablename, PluralName, primaryKeyName, primaryKeyDatatype, namespaceString);
            ...
            GenericDataService genericDataService = new(Columns, ModelName, camelTablename, PluralName, primaryKeyName, primaryKeyDatatype, namespaceString);
            ...
            GenericTableCodeBehind genericTableCodeBehind = new(Columns, ModelName, camelTablename, PluralName, primaryKeyName, primaryKeyDatatype, namespaceString);
